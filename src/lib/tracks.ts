...
export const TRACKS: Record<TrackId, Track> = {
  research: {
    ...
    name: "Researcher",
    nameEn: "Researcher",
    tagline: "撰写一份科研笔记或论文评议",
    description:
      "从阅读开放科学论文或参与同行评议开始,学会产出可被链上存证与引用的研究笔记。",
    accent: "#1e3a5c",
    participants: 128,
    avgHours: "2–3 小时",
    resources: [
  ...
  science: {
    ...
    name: "Translator",
    nameEn: "Translator",
    tagline: "把前沿硬核内容精译给更多人",
    description:
      "打破语言与硬核术语门槛,通过高质量翻译与解读,帮助更多华语读者无缝跨入 DeSci。",
    accent: "#3f6b45",
    participants: 96,
    avgHours: "1–2 小时",
    resources: [
  ...
  builder: {
    ...
    name: "Builder",
    nameEn: "Builder",
    tagline: "参与开源代码与生态工具建设",
    description:
      "从提交 GitHub Issue/PR 到搭建社区公共工具,用真实的工程交付建立你的链上贡献信誉。",
    accent: "#c0532d",
    participants: 154,
    avgHours: "2–4 小时",
    resources: [
  ...
  community: {
    ...
    name: "Founder",
    nameEn: "Founder",
    tagline: "发起 DeSci 项目并获取早期资助",
    description:
      "将科研灵感或创新构想转化为结构化提案,通过社区 Grant、二次方融资或开源众筹获取第一笔启动资金。",
    accent: "#8a5a9e",
    participants: 73,
    avgHours: "1 小时",
    resources: [
